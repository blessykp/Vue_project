          ...
          <div class="container">
                ...
                <div class="col-sm-5">
                  ...
                  <div class="follow_social_icon">
                    <ul>
                      ...
                      <li>
                        <a href="#"><img src="../assets/images/linkden-icon.png" /></a>
                      </li>
                      <li>
            ...
            <div class="images_main">
              <div class="row">
                ...
                <div class="col-sm-5">
                  <div class="image_4"><img src="../assets/images/img-5.png" /></div>
                  <h6 class="follow_text">Follow Us</h6>
                  <div class="follow_social_icon">
                    <ul>
                      <li>
            ...
            <div class="images_main_1">
              <div class="row">
                <div class="col-sm-5">
                  <div class="image_4"><img src="../assets/images/img-6.png" /></div>
                  <h6 class="follow_text">Follow Us</h6>
                  <div class="follow_social_icon">
                    <ul>
                      <li>
            ...
            <div class="images_main">
              <div class="row">
                ...
                <div class="col-sm-5">
                  <div class="image_4"><img src="../assets/images/img-7.png" /></div>
                  <h6 class="follow_text">Follow Us</h6>
                  <div class="follow_social_icon">
                    <ul>
                      <li>
            ...
            <div class="col-md-6">
              ...
              <div class="social_icon">
                <ul>
                  ...
                  <li>
                    <a href="#"><img src="../assets/images/twitter-icon1.png" /></a>
                  </li>
                  <li>
                    <a href="#"><img src="../assets/images/linkden-icon1.png" /></a>
                  </li>
                  <li>
                    <a href="#"><img src="../assets/images/instagram-icon1.png" /></a>
                  </li>
                </ul>
              </div>
            </div>
