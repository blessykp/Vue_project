  ...
  <div class="footer_section layout_padding">
    <div class="container">
      <div class="footer_main">
        ...
        <div class="footer_left">
          <div class="location_text"><a href="#"><img src="src/assets/images/map-icon.png"><span
                class="padding_left_15">Locations</span></a></div>
        </div>
        <div class="footer_left">
          <div class="location_text"><a href="#"><img src="src/assets/images/call-icon.png"><span
                class="padding_left_15">+71 9876543210</span></a></div>
        </div>
        <div class="footer_left">
          <div class="location_text"><a href="#"><img src="src/assets/images/map-icon.png"><span
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="mail_section">
              ...
              <textarea class="massage_text" placeholder="Message" rows="5" v-model="message" name="Message"></textarea>
