<template>
  <div>
    <div class="team_section layout_padding">
      <div class="container">
        <h1 class="choose_taital"><span>Our </span> <img src="src/assets/images/icon-1.png"> <span style="color: #1f1f1f">Team</span></h1>
        ...
        <div class="team_section_2 layout_padding">
          <div class="container">
            <div class="images_main_1">
              <div class="row">
                <div class="col-sm-5">
                  <div class="image_4"><img src="src/assets/images/img-4.png"></div>
                  ...
                  <div class="follow_social_icon">
                    <ul>
                      ...
                      <li><a href="#"><img src="src/assets/images/linkden-icon.png"></a></li>
            ...
            <div class="images_main">
              <div class="row">
                ...
                <div class="col-sm-5">
                  <div class="image_4"><img src="src/assets/images/img-5.png"></div>
                  <h6 class="follow_text">Follow Us</h6>
                  <div class="follow_social_icon">
                    <ul>
                      <li><a href="#"><img src="src/assets/images/fb-icon.png"></a></li>
            ...
            <div class="images_main_1">
              <div class="row">
                <div class="col-sm-5">
                  <div class="image_4"><img src="src/assets/images/img-6.png"></div>
                  <h6 class="follow_text">Follow Us</h6>
                  <div class="follow_social_icon">
                    <ul>
                      <li><a href="#"><img src="src/assets/images/fb-icon.png"></a></li>
            ...
            <div class="images_main">
              <div class="row">
                ...
                <div class="col-sm-5">
                  <div class="image_4"><img src="src/assets/images/img-7.png"></div>
                  <h6 class="follow_text">Follow Us</h6>
                  <div class="follow_social_icon">
                    <ul>
                      <li><a href="#"><img src="src/assets/images/fb-icon.png"></a></li>
