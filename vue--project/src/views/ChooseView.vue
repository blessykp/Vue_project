<template>
  <div class="choose_section layout_padding">
      <div class="container">
        <h1 class="choose_taital"><span>Why </span> <img src="src/assets/images/icon-1.png"> <span style="color: #1f1f1f">Choose Us</span></h1>
        ...
        <div class="choose_section_2 layout_padding">
          ...
          <div class="image_3"><img src="src/assets/images/img-3.png"></div>
